        ...
        <article class="sabbi-thumlinepost-card solitude-bg__x">
            <a href="{{url('climate-change-evidence-and-security')}}">
                <figure class="sabbi-thumlinepost-card-figure">
                    <img src="/frontend/assets/img/panel/climateChangeEvidence.jpg" alt=""
    ...
    <div class="col-md-3 col-sm-6">
        <article class="sabbi-thumlinepost-card solitude-bg__x">
            <a href="{{url('climate-change-response')}}" style="color:inherit">
                <figure class="sabbi-thumlinepost-card-figure">
                    <img src="/frontend/assets/img/panel/climateChangeResponse.jpg" alt=""
                         class="img-responsive img-thumpost">
                </figure>
            </a>
            <div class="sabbi-thumlinepost-card-meta">
    ...
    <div class="col-md-3 col-sm-6">
        <article class="sabbi-thumlinepost-card solitude-bg__x">
            <a href="{{url('policy-and-governance-of-climate-change-response-and-sustainability')}}"
               style="color:inherit">
                <figure class="sabbi-thumlinepost-card-figure">
                    <img src="/frontend/assets/img/panel/policy.jpg" alt=""
                         class="img-responsive img-thumpost">
                </figure>
            </a>
            <div class="sabbi-thumlinepost-card-meta">
