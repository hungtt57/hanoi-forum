        ...
        <div class="site-hmsl-content text-center mt_60">
            <div class="seq seq--kawsa" id="sequence">
                <div class="seq-screen">
                    <ul class="seq-canvas">
                        @php $posts = App\Models\Post::where('status',1)->orderBy('created_at','desc')->get()->toArray(); @endphp
                                ...
                                {{--@if($loop->index == 0)--}}
                                    @if(count($posts))
                                        ...
                                        <div class="seq-content" >
                                            <a href="{{url('post').'/'.str_slug($posts[$index]['title']).'-'.$posts[$index]['id']}}" style="border-bottom: none !important;" class="btn-link btn-more">
                                            <h3 style="font-size: 25px;border-bottom: none !important;" class="seq-title font-2 tt_up" data-seq="">{{ $posts[$index]['title']}}</h3>
