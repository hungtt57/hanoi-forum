        ...
        <div class="seq seq--kawsa" id="sequence">
            <div class="seq-screen">
                <ul class="seq-canvas">
                    ...
                    <li class="seq-step2" id="step2" style="background:url(/frontend/banner/slide2.jpg);background-repeat: no-repeat;background-size: cover;background-position: center center;">
                        <div class="bg-blend"></div>
                        {{--<div class="seq-content" >--}}
                    ...
                    {{--<li class="seq-step3" id="step3" style="background:url(/frontend/banner/slide3.jpg);background-repeat: no-repeat;background-size: cover;background-position: center center;">--}}
                        {{--<div class="bg-blend"></div>--}}
                    {{--</li>--}}
                    <li class="seq-step4" id="step4" style="background:url(/frontend/banner/slide4.jpg);background-repeat: no-repeat;background-size: cover;background-position: center center;">
                        <div class="bg-blend"></div>
                        {{--<div class="seq-content" >--}}
