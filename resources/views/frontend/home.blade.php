            ...
            <div class="row home-info-block-first">
                ...
                <div class="col-md-3 col-sm-6">
                    <article class="sabbi-thumlinepost-card solitude-bg__x">
                        ...
                        <div class="sabbi-thumlinepost-card-meta">
                            <a href="{{url('humans-impact-climate')}}" style="color:inherit"> <h2 class="meta-title ht-5">Humans impact climate</h2> </a>
                ...
                <div class="col-md-3 col-sm-6">
                    <article class="sabbi-thumlinepost-card solitude-bg__x">
                        <a href="{{url('policy-and-governance-of-climate-change-response-and-sustainability')}}" style="color:inherit">
                        <figure class="sabbi-thumlinepost-card-figure">
