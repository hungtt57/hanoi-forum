...
@section('content')
    <style>
        .sabbi-page-header {
            background-image: url({{url('frontend/anhbanner/10.jpg')}});
        ...
        <header class="sabbi-page-header page-header-lg"
            ...
            <div class="page-header-content conternt-center">
                <div class="header-title-block">
                    <h1 class="page-title">Hanoi Experience</h1>
                </div>
            </div>
        </header>
                ...
                <div class="row">
                    <div class="content-page">
                        <div class="col-md-8 col-sm-5 col-md-offset-2 col-xs-12">
                            <div class="col-md-12">
                                @php $article = \App\Models\Article::where('title','hanoiex')->first(); @endphp
                                @if($article)
                                    {!! $article->content !!}
                                @endif
                                {{--<ol>--}}
